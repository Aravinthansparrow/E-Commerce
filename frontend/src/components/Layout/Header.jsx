...
function Header({activeHeading}) {
    ...
    const handleSearchChange = (e) => {
        ...
        const filterProducts = productData && productData.filter((product) => product.name.toLowerCase().includes(term.toLowerCase())
        )
        ...
        <>
            <div className={`${styles.section}`}>
                <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
                    <div>
                        <Link to="/">
                            <h1 className='text-2xl font-extrabold text-gray-900'>E-COMMERCE</h1>
                        </Link>
                    </div>
