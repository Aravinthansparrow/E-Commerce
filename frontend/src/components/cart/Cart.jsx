                ...
                <div className='px-5 mb-3'>
                    <Link to="/checkout">
                        <div className={'h-[45px] flex items-center justify-center w-[100%] bg-[#e44343] rounded-[5px]'}>
                            <h1 className='text-[#fff] text-[18px] font-[600]'>Checkout Now (USD$1080)</h1></div>
                    </Link>
        ...
        <div className='border-b p-4'>
            <div className="w-full.flex.items-center">
                ...
                <div>
                    ...
                    <div className='bg-[#a7abb14f] rounded-full w-[25px] h-[25px] flex items-center justify-center cursor-pointer ' onClick={() => setValue(value === 1 ? 1 : value - 1)}><HiOutlineMinus size={16} color="#7d89c" />
                    </div>
                ...
                <div className='pl-[5px] '>
                    <h1>{data.name}</h1>
                    <h4 className='font-[400] text-[15px] text-[#00000082] '>${data.price} * {value}
                    </h4>
